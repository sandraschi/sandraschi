...
"Mass production" for a two-meter piloted mecha deserves real skepticism, even if the price eventually drops toward $80k — who is the buyer placing an order for a hundred of these? Not a household, not a warehouse. Industrial ops, rescue, and "cultural tourism" (Unitree's own stated markets) don't generate hundred-unit orders either. The order-size that actually makes "mass production" a coherent sentence is a military procurement budget — the PLA, or some other national military looking for a cheap rideable walker. Meanwhile the US answer to the same capability gap will, with near total predictability, be Northrop Grumman delivering a not-quite-as-good equivalent on a cost-plus contract north of $200 million sometime around 2030 — a pattern US officers reportedly recognize and resent as much as anyone. Ukraine's field-engineering culture, meanwhile, has repeatedly shown it can improvise a rough working equivalent of expensive hardware faster and cheaper than any formal acquisition program, purely out of wartime necessity — and even a crude, non-lethal walker has real documented value dug-in infantry take seriously: sheer intimidation and morale effect is a genuine, if unglamorous, military use case, not just spectacle.
