...
Who runs this fleet, where it runs, and what is worth reading. Linked from the [main page](README.md), kept separate so that page stays short.
...
One beefy Windows box (Goliath, RTX 4090), a Yahboom robot car called Boomy, a German Shepherd security consultant, and soon a Noetix Bumi humanoid. Details: [Workshop](WORKSHOP.md) - [Bumi](BUMI.md).

---

## Benny

Benny, 2-year-old German Shepherd. Security consultant and tennis ball lifecycle manager at the Alsergrund node.
...
<p align="center"><a href="CHANGELOG.md">Changelog</a> - <a href="README.md">Back to main</a></p>
